...
pub(crate) fn resolve_simple_type(
    ...
    Some(match ty? {
        ...
        TSType::TSTypeReference(r) => {
            resolve_type_reference(r, types, aliases, type_params, diagnostics)
        }
...
fn resolve_type_reference(
    ...
    match &r.type_name {
        ...
        TSTypeName::QualifiedName(_) | TSTypeName::ThisExpression(_) => types.intern(&Type::Error),
    }
}

fn try_resolve_builtin_generic(
    name: &str,
    r: &oxc_ast::ast::TSTypeReference<'_>,
    types: &mut TypeTable,
    aliases: Option<&HashMap<String, TypeId>>,
